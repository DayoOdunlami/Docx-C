        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-catapult-green hover:bg-greenTints-80" asChild>
                <Link href="/demo/siz">View SIZ Demo</Link>
              </Button>
              <Button size="lg" variant="outline" className="border-catapult-green text-catapult-green" asChild>
                <Link href="/demo/credo">View CReDo Demo</Link>
              </Button>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="bg-card">
              ...
              <CardContent>
                ...
                <Button variant="outline" className="border-catapult-green text-catapult-green" asChild>
                  <Link href="/demo/siz">Explore SIZ →</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-card">
              ...
              <CardContent>
                ...
                <Button variant="outline" className="border-catapultBlue1 text-catapultBlue1" asChild>
                  <Link href="/demo/credo">Explore CReDo →</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
